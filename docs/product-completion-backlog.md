...
| A12 | Human-in-the-loop approval experience | **MUST**, restyle only | `ApprovalCard` (`App.jsx:129-218`) already has a considered approve/reject-with-note flow. |
