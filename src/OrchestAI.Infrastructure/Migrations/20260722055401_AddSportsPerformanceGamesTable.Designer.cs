...
namespace OrchestAI.Infrastructure.Migrations
{
    ...
    [Migration("20260722055401_AddSportsPerformanceGamesTable")]
    partial class AddSportsPerformanceGamesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrchestAI.Domain.Entities.IdempotencyRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OrchestAI.Domain.Entities.RejectionEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RejectionEvents", (string)null);
                });

            modelBuilder.Entity("OrchestAI.Domain.Entities.TaskAdmissionReservation", b =>
                {
                    b.Property<Guid>("TaskId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TaskAdmissionReservations", (string)null);
                });
            ...
            modelBuilder.Entity("OrchestAI.Domain.Entities.TenantLimits", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<decimal?>("DailyCostBudgetUsd")
                        .HasColumnType("decimal(18,6)");

                    b.Property<int?>("MaxAgentsPerTask")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("MaxToolCallsPerTask")
                        .HasColumnType("integer");

                    b.Property<decimal?>("MonthlyCostBudgetUsd")
                        .HasColumnType("decimal(18,6)");
                    ...
                    b.ToTable("TenantLimits", (string)null);
                });
            ...
            modelBuilder.Entity("OrchestAI.Domain.Entities.TaskAdmissionReservation", b =>
                {
                    b.HasOne("OrchestAI.Domain.Entities.OrchestrationTask", null)
                        .WithMany()
